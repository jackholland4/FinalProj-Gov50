...
composite_plot <- composite_returns |>
  mutate(comp_swing = (`JOSEPH R BIDEN` / (`JOSEPH R BIDEN` / `DONALD J TRUMP`) - (`clinton` / (`clinton` * `trump`)))) |>
  ...
  labs(
    title = "2016-2020 Presidential Raw Swings",
    x = "Precinct (School District)",
    y = "Two Way Raw Swing (D-R)")
...
Firstly, a look at the townwide election results in 2016 and 2020:
```{r}
