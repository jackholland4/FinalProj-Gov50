...
voting_demographics <-
  ...
  ungroup() |>
  filter(!totals == "")
knitr::kable(head(voting_demographics))
```
```{r}
...
wealth_plot <- voting_pivoted |>
  ...
  labs(title = "Bar Plot of d_swing vs. wealth_perc", x = "% Earning >$75,000/yr", y = "d_swing")
...
col_plot <- voting_pivoted |>
  ...
  geom_bar(stat = "identity") +
  geom_smooth(method = "lm", se = FALSE) +
  labs(title = "Bar Plot of d_swing vs. wealth_perc", x = "% with a Bachelor's Degree", y = "d_swing")
...
white_plot <- voting_pivoted |>
  ...
  geom_bar(stat = "identity") +
  geom_smooth(method = "lm", se = FALSE) +
  labs(title = "Bar Plot of d_swing vs. wealth_perc", x = "% White non-Hispanic", y = "d_swing")

wealth_plot + col_plot + white_plot


knitr::kable(voting_pivoted)
```
